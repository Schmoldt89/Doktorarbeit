# BB_02 rausgenommen, weil keine Ruhephase eingezeichnet
#HVR_102_WH rausgenomemn
#dummyvars bei HVR_102_WH_02 eingefügt in HCVR
...
def truedata_eval_hvr1(datasheet):
    ...
    datasheet['A8'] = "MitRuheSpO2" # Average(limiter_beg1, limiter_end1), Column P
    sumvar =0
    iterate=0
    ...
    datasheet['A9'] = "MitRuhePetO2" # Average(limiter_beg1, limiter_end1), Column Q
    sumvar =0
    iterate=0
    ...
    datasheet['A10'] = "MitRuhePetCO2" # Average(limiter_beg1, limiter_end1), Column R
    sumvar =0
    iterate=0
    ...
    datasheet['A11'] = "MitHVRPetCO2" # Average(limiter_beg2, limiter_end2), Column R
    sumvar =0
    iterate=0
    ...
    datasheet['A12'] = "StandAbwPetCO2" # STDEV.S(limiter_beg2, limiter_end2), Column R
    r2_arr = []
    for l in datasheet.iter_rows(min_row=limiter_beg2, max_row=limiter_end2, min_col=18, max_col=18):
        r2_arr.append(l[0].value)
    datasheet['B12'] = statistics.stdev(r2_arr)

    datasheet['A13'] = "KorVE/SpO2" # Korrelation(limiter_beg1 (K), limiter_end1(K), limiter_beg2(P), limiter_end2(P)), Column K, P
    corr2=np.corrcoef(k2_arr, p2_arr)[0][1]
    datasheet['B13'] = corr2

    datasheet['A14'] = "KorVE/SpO2 t-Wert"
    t_wert = float(corr2 * math.sqrt(54))/(math.sqrt(1-(corr2**2)))
    datasheet['B14'] = t_wert

    datasheet['A15'] = "KorVE/SpO2 p-Wert"
    #datasheet['B15'] = "=T.DIST.2T(ABS(B14),52)" #excel-syntax  /kann openpyxl nicht parsen /TODO: fix
    datasheet['B15'] = t.ppf((1-(abs(t_wert)/2)), df=52)
    #print(t_wert)
    #print(t.ppf((abs(t_wert)), 52))
    #stats.t.ppf(1-alfa, free_deg)

    datasheet['A16'] = "RegVE/SPO2"
    datasheet['B16'] = np.polyfit(p2_arr, k2_arr,1)[0]
    return datasheet
...
def data_eval_hvr1(datasheet):
    ...
    datasheet['A8'] = "MitRuheSpO2"
    datasheet['B8'] = "=AVERAGE(P" + str(limiter_beg1) + ":P" + str(limiter_end1) + ")"

    datasheet['A9'] = "MitRuhePetO2"
    datasheet['B9'] = "=AVERAGE(Q" + str(limiter_beg1) + ":Q" + str(limiter_end1) + ")"

    datasheet['A10'] = "MitRuhePetCO2"
    datasheet['B10'] = "=AVERAGE(R" + str(limiter_beg1) + ":R" + str(limiter_end1) + ")"

    datasheet['A11'] = "MitHVRPetCO2"
    datasheet['B11'] = "=AVERAGE(R" + str(limiter_beg2) + ":R" + str(limiter_end2) + ")"

    datasheet['A12'] = "StandAbwPetCO2"
    datasheet['B12'] = "=STDEV(R" + str(limiter_beg2) + ":R" + str(limiter_end2) + ")"

    datasheet['A13'] = "KorVE/SpO2"
    datasheet['B13'] = "=CORREL(K" + str(limiter_beg2) + ":K" + str(limiter_end2) + ",P" + str(limiter_beg2) + ":P" + str(limiter_end2) + ")"

    datasheet['A14'] = "KorVE/SpO2 t-Wert"
    datasheet['B14'] = "=(B13*SQRT(54))/(SQRT(1-B13^2))"

    #BUG: t.sidt.2t is lower case, value can't be calculated; /TODO: fix
    datasheet['A15'] = "KorVE/SpO2 p-Wert"
    #datasheet['B15'] = "=T.DIST.2T(ABS(B14),52)"   #excel-syntax
    datasheet['B15'] = "=T.DIST(ABS(B14),52)"

    datasheet['A16'] = "RegVE/SPO2"
    datasheet['B16'] = "=LINEST(K" + str(limiter_beg2) + ":K" + str(limiter_end2) + ",P" + str(limiter_beg2) + ":P" + str(limiter_end2) + ")"
...
for wb in list_of_spreadfiles:
    ...
    if hvcr in wb.sheetnames:
       data_eval_hcvr(wb[hvcr])
       #data_eval_hcvr_with_mean_RuhePetCO2(wb[hvcr], wb[hvr1])
